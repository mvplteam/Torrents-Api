...
------------ | ------------- | ------------- | -------------
1337x | 1337x | https://1337xx.to | [/api/1337x/avengers](https://apits.herokuapp.com/api/1337x/avengers)
Yts   | yts | https://yts.mx | [/api/yts/avengers](https://apits.herokuapp.com/api/yts/avengers)
Eztv  | eztv | https://eztv.re | [/api/eztv/avengers](https://apits.herokuapp.com/api/eztv/avengers)
Torrent Galaxy | tgx | https://torrentgalaxy.to | [/api/tgx/avengers](https://apits.herokuapp.com/api/tgx/avengers)
Torlock | torlock | https://www.torlock.com | [/api/torlock/avengers](https://apits.herokuapp.com/api/torlock/avengers)
PirateBay | piratebay | https://thehiddenbay.com | [/api/piratebay/avengers](https://apits.herokuapp.com/api/piratebay/avengers)
Nyaa.si | nyaasi | https://nyaa.si | [/api/nyaa/umaru](https://apits.herokuapp.com/api/nyaa/umaru)
Rarbg | rarbg  | https://rargb.to | [/api/rarbg/avengers](https://apits.herokuapp.com/api/rargb/avengers)
Ettv | ettv  | https://www.ettvcentral.com | [/api/ettv/avengers](https://apits.herokuapp.com/api/ettv/avengers)
all | all (it will retrieve torrent from every site) | | [/api/all/avengers](https://apits.herokuapp.com/api/all/avengers)
